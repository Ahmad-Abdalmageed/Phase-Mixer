...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Icons/icons8-file-256.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.img2Load.setIcon(icon)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.component1.setItemText(1, _translate("MainWindow", "Phase"))
        self.component1.setItemText(2, _translate("MainWindow", "Real Component"))
        self.component1.setItemText(3, _translate("MainWindow", "Imaginary Component"))
        self.component1.setItemText(4, _translate("MainWindow", "Uniform Magnitude"))
        self.component1.setItemText(5, _translate("MainWindow", "Uniform Phase "))
        ...
        self.component2.setItemText(0, _translate("MainWindow", "Magnitude"))
        self.component2.setItemText(1, _translate("MainWindow", "Phase"))
        self.component2.setItemText(2, _translate("MainWindow", "Real Component"))
        self.component2.setItemText(3, _translate("MainWindow", "Imaginary Component"))
        self.component2.setItemText(4, _translate("MainWindow", "Uniform Magnitude"))
        self.component2.setItemText(5, _translate("MainWindow", "Uniform Phase "))
